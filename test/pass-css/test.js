...
async function main(build) {
    ...
    assert.strictEqual(styles[0].innerHTML, 'button.c14{padding:4px}.btn.c15{margin:0px}.btn.c16{cursor:pointer}.color.c17{color:rgba(0,0,0,0.87);border:1px solid rgba(0,0,0,0.23)}.color.c17:hover{background-color:rgba(0,0,0,0.04)}');
    ...
    equalClass(buttons[0], 'c14  btn c15  btn c16  color c17');
    equalClass(buttons[1], 'c14  btn c15  btn c16  blue c12');
    equalClass(buttons[2], 'c14  btn c15  btn-two c10  red c11');
    equalClass(buttons[3], 'c14  btn c15  btn c16  color c17');
    ...
    equalClass(buttons[1], 'c14  btn c15  btn c16  blue c12');
    equalClass(buttons[2], 'c14  btn c15  btn-two c10  red c11');
    equalClass(buttons[3], 'c14  btn c15  btn c16  green c7');
