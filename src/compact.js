      ...
      if (node.type == 'text' && !node.value.trim()) {
        ...
        if (prev && next) {
          if (prev.type == 'node' && next.type == 'node') {
            if (isTable(prev) && isTable(next) || prev.name == 'li' && next.name == 'li' ||
          ...
          const p = prev && prev.type == 'node' && prev.name;
          const n = next && next.type == 'node' && next.name;
